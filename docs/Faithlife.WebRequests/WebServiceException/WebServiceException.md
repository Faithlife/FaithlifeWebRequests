...
```csharp
public WebServiceException(string message = null, string requestMethod = null, Uri requestUri = null, 
    HttpStatusCode? responseStatusCode = default(HttpStatusCode?), HttpHeaders responseHeaders = null, 
    string responseContentType = null, long? responseContentLength = null, 
    string responseContentPreview = null, Exception innerException = null)
```
